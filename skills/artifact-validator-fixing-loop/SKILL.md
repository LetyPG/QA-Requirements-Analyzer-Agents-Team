...
```json
  ...
  "report_path_agent_risk_evaluator": [
    "${pathTo}risk-evaluator-qa-strategies/ouptuts/risk_evaluator_qa_strategy_{RF_ID}.md"
    "${pathTo}risk-evaluator-qa-strategies/ouptuts/strategy_{RF_ID}.json",
    "${pathTo}risk-evaluator-qa-strategies/${pathTo}/history_{RF_ID}.json"
  ],
  "status": "COMPLETED",
